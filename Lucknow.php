...
<body>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>Subham Kumar</td>
                <td>Subham Enclave, Gumti Nagar, Lucknow</td>
                <td>50.0 Lakhs</td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>Gulmohar Vihaar, Shahstri Nagar, Lucknow</td>
                <td>3 Crores</td>
            </tr>
        </tbody>
    </table>
    <div class="div2">
        <img src="Lucknow4.jpg" alt="">
        <br>
        <br>
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
            industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
    ...
    <table>
        ...
        <?php
            ...
            {
                $sql = "SELECT holdername, address, price from properties where upper(address) LIKE '% LUCKNOW'";
    ...
    <table>
        ...
        <?php
            ...
            {
                $sql = "SELECT name, userid, email, city from registration where city = 'Lucknow'";
                $result = $conn-> query($sql);
