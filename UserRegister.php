...
<body>
    <div class="container">
        ...
        <form autocomplete="off" enctype="multipart/form-data" method="post" action="http://localhost/adduser.php"
            onsubmit="return validate(this);" name="form">
            <div class="info" style="padding-left:20px">
                <h2>Welcome User! We'll love to show you some good REAL ESTATE</h2>
                <h3>Please provide some details below so that we can register you</h3>
                <ul>
                    <li id="foli1" class="   ">
        ...
        function goToRealtor() {
            window.open('RegisterForm.php');
